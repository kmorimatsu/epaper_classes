...
LABEL C_EPD_5IN83B_V2_CLEAR
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f822,$bd00,$46c0
LABEL C_EPD_5IN83B_V2_DISPLAY
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f862,$bd00,$46c0
LABEL C_EPD_5IN83B_V2_SLEEP
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f8b8,$bd00,$46c0
LABEL C_MACHIKANIA_INIT
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f8c8,$bd00,$46c0
LABEL C_DEV_GPIO_INIT
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f8d6,$bd00,$46c0
