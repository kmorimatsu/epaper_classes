...
LABEL INIT_C
  DIM C_RAM(31)
  REM ram vectors
  POKE32 DATAADDRESS(C_FUNCTIONS)+744,C_RAM+0
  POKE32 DATAADDRESS(C_FUNCTIONS)+888,C_RAM+28
  ...
  POKE32 DATAADDRESS(C_FUNCTIONS)+904,C_RAM+92
  POKE32 DATAADDRESS(C_FUNCTIONS)+908,C_RAM+108
  ...
  POKE32 DATAADDRESS(C_FUNCTIONS)+1252,C_RAM+60
  POKE32 DATAADDRESS(C_FUNCTIONS)+2356,C_RAM+0
  REM rodata vectors
...
LABEL C_DEV_GPIO_INIT
  EXEC $b082,$69f0,$9000,$6a30,$9001,$68f0,$6931,$6972,$69b3,$f000,$f97f,$b002,$bd00,$46c0

REM 2608 bytes
LABEL C_FUNCTIONS
EXEC $b580,$af00,$f000,$f9ca,$2001,$f000,$f9f1,$2003,$f000,$fa1a,$2000,$f000,$fa17,$202b,$f000,$fa14,
     $202b,$f000,$fa11,$2003,$f000,$fa0e,$2006,$f000,$f9df,$2017,$f000,$fa08,$2017,$f000,$fa05,$2017,
     $f000,$fa02,$2004,$f000,$f9d3,$f000,$fa29,$2000,$f000,$f9ce,$20bf,$f000,$f9f7,$200e,$f000,$f9f4,
     $2030,$f000,$f9c5,$203a,$f000,$f9ee,$2061,$f000,$f9bf,$2080,$f000,$f9e8,$2001,$f000,$f9e5,$2028,
     $f000,$f9e2,$2082,$f000,$f9b3,$2028,$f000,$f9dc,$bf00,$bd80,$b580,$b084,$af00,$2310,$80fb,$f44f,
     $7394,$80bb,$b580,$b084,$af00,$2310,$80fb,$f44f,$7394,$80bb,$2010,$f000,$f99b,$2300,$81fb,$e00f,
     $2300,$81bb,$e005,$2000,$f000,$f9be,$89bb,$3301,$81bb,$89ba,$88fb,$429a,$d3f5,$89fb,$3301,$81fb,
     $89fa,$88bb,$429a,$d3eb,$2013,$f000,$f981,$2300,$817b,$e00f,$2300,$813b,$e005,$20ff,$f000,$f9a4,
     $893b,$3301,$813b,$893a,$88fb,$429a,$d3f5,$897b,$3301,$817b,$897a,$88bb,$429a,$d3eb,$f000,$f9ea,
     $f000,$fa66,$bf00,$3710,$46bd,$bd80,$b580,$b086,$af00,$6078,$2310,$81fb,$f44f,$7394,$b580,$b086,
     $af00,$6078,$2310,$81fb,$f44f,$7394,$81bb,$2010,$f000,$f94e,$2300,$82fb,$e00f,$2300,$82bb,$e005,
     $2000,$f000,$f971,$8abb,$3301,$82bb,$8aba,$89fb,$429a,$d3f5,$8afb,$3301,$82fb,$8afa,$89bb,$429a,
     $d3eb,$2013,$f000,$f934,$2300,$827b,$e019,$2300,$823b,$e00f,$8a3a,$8a7b,$89f9,$fb01,$f303,$4413,
     $461a,$687b,$4413,$781b,$4618,$f000,$f94d,$8a3b,$3301,$823b,$8a3a,$89fb,$429a,$d3eb,$8a7b,$3301,
     $827b,$8a7a,$89bb,$429a,$d3e1,$f000,$f993,$f000,$fa0f,$bf00,$3718,$46bd,$bd80,$b580,$b084,$af00,
     $6078,$f7ff,$fe93,$2091,$b580,$b084,$af00,$6078,$f000,$fa12,$2091,$f000,$f8fb,$2090,$f000,$f8f8,
     $2000,$f000,$f921,$207f,$f000,$f91e,$2000,$f000,$f91b,$2000,$f000,$f918,$2001,$f000,$f915,$2027,
     $f000,$f912,$2028,$f000,$f90f,$2310,$817b,$2013,$f000,$f8de,$2300,$81fb,$e019,$2300,$81bb,$e00f,
     $89ba,$89fb,$8979,$fb01,$f303,$4413,$461a,$687b,$4413,$781b,$4618,$f000,$f8f7,$89bb,$3301,$81bb,
     $89ba,$897b,$429a,$d3eb,$89fb,$3301,$81fb,$89fb,$f5b3,$7f94,$d3e1,$f000,$f9bb,$bf00,$3710,$46bd,
     $bd80,$b580,$af00,$2050,$f7ff,$fd5f,$20f7,$f7ff,$b580,$af00,$2050,$f000,$f8ab,$20f7,$f000,$f8d4,
     $2002,$f000,$f8a5,$f000,$f8fb,$2007,$f000,$f8a0,$20a5,$f000,$f8c9,$bf00,$bd80,$0000,$b580,$af00,
     ...
     $2b29,$d9f2,$bf00,$bf00,$3708,$46bd,$bd80,$bf00,$b62c,$1000,$b658,$1000,$b684,$1000,$b6b0,$1000,
     $b6dc,$1000,$b580,$b082,$af00,$2082,$f7ff,$ff12,$b580,$af00,$2012,$f7ff,$fefb,$200a,$f000,$f8d8,
     ...
     $b708,$1000,$b734,$1000,$b760,$1000,$b78c,$1000,$b7b8,$1000,$b580,$af00,$2012,$f7ff,$fe95,$200a,
