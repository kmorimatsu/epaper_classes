...
void machikania_sleep_us(unsigned int time){
	machikania_lib(time,0,0,LIB_DELAYUS);
}

void machikania_sleep_ms(unsigned int time){
	machikania_lib(time,0,0,LIB_DELAYMS);
}
