...
LABEL C_EPD_2IN13_V2_DISPLAY
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f968,$bd00,$46c0
LABEL C_EPD_2IN13_V2_DISPLAYPART
  EXEC $68f0,$6931,$6972,$69b3,$f000,$f9b4,$bd00,$46c0
LABEL C_EPD_2IN13_V2_DISPLAYPARTBASEIMAGE
  EXEC $68f0,$6931,$6972,$69b3,$f000,$fa00,$bd00,$46c0
LABEL C_EPD_2IN13_V2_SLEEP
  EXEC $68f0,$6931,$6972,$69b3,$f000,$fa8a,$bd00,$46c0
LABEL C_MACHIKANIA_INIT
  EXEC $68f0,$6931,$6972,$69b3,$f000,$faa0,$bd00,$46c0
LABEL C_DEV_GPIO_INIT
  EXEC $68f0,$6931,$6972,$69b3,$f000,$faae,$bd00,$46c0
